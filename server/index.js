...
const instanceUrl = INSTANCE + "pop6_sh_hooks.php";
...
const webhooks = {
  ...
  ORDERS_CREATE: {
    ...
    webhookHandler: async (topic, shop, body) => {
      (async () => {
        const rawResponse = await fetch(`${instanceUrl}`, {
          method: "POST",
          headers: {
  ...
  //           "Content-Type": "application/x-www-form-urlencoded",
  //           Shop: `${shop}`,
  //           Webhook: "CARTS_CREATE",
  //         },
  //         body: body,
  //       });
  //       const content = await rawResponse;
  //       console.log(content);
  //       console.log("CARTS_CREATE");
  //     })();
  //   },
  // },
  CARTS_UPDATE: {
      ...
      (async () => {
        const rawResponse = await fetch(`${instanceUrl}`, {
          ...
          headers: {
            "Content-Type": "application/x-www-form-urlencoded",
            Shop: `${shop}`,
            Webhook: "CHECKOUTS_CREATE",
          },
          body: body,
        });
        const content = await rawResponse;
        console.log(content);
        console.log("CHECKOUTS_CREATE");
      })();
    },
  },
};

function setShopifyWebhookRegistry() {
